...
const CebeceraConBuscador = () => {
  return (
    <header
      ...
      className="sticky top-0 w-full flex  items-center justify-between px-[3vw] bg-[#ffffff80] border-black -border-b-[1px] -shadow-[0px_0px_10px_2px_#00000025] h-max py-4 z-[103] [backdrop-filter:blur(10px)] gap-4 "
    >
      <Link href={"/"} as={"/"}>
        <span
